                ...
                <div>
                    ...
                    <ul className="space-y-2 text-xs md:text-sm">
                        <li>
                            <button 
                                onClick={() => navigate('/nosotros')} 
                                className="hover:text-brand-yellow transition duration-300 cursor-pointer bg-transparent border-none p-0 text-slate-300 font-normal outline-none"
                            >
                                Políticas de Compra
                            </button>
                        </li>
                ...
                <div>
                    ...
                    <ul className="space-y-3 text-xs md:text-sm">
                        ...
                        <li className="flex items-center gap-3">
                            ...
                            <a href="mailto:info@bloquemundo.com" className="hover:text-brand-yellow transition text-slate-300 no-underline">info@bloquemundo.com</a>
                        </li>
                        <li className="flex items-center gap-3">
